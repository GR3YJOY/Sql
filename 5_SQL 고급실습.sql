...
INSERT INTO `Member` VALUES ('a107', '정철',     '010-1234-1007', '부장', 103, NOW());
...
INSERT INTO `Department` VALUES (106, '영업자원부', '051-512-1006');
...
SELECT * FROM `Sales` WHERE `sale` >= 5000 AND `sale` < 100000 AND `month`=1;
